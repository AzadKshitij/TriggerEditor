...
def print_results(all_results):
    ...
    if successful_results:
        ...
        for result in successful_results:
            print(f"{result['method']:<35} {result['time']:<10.2f} {result['memory_used']:<12.1f} {result.get('dataframe_memory', 0):<15.1f} {result['rows']:<10,} {result['columns']:<6}")
    ...
    if failed_results:
        ...
        for result in failed_results:
            print(
                f"{result['method']:<35} {result.get('error', 'Unknown error'):<50}")
