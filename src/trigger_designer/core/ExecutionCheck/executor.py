...
class NodeExecutionError(Exception):
    ...
    def __init__(self, message: str, node_name: str = "", line_number: int = 0, 
...
class NodeExecutor:
    ...
    def _execute_with_timeout(self, code: str, local_vars: Dict[str, Any], 
                            timeout: float) -> Tuple[bool, Optional[Exception]]:
    ...
    def execute_node(self, node: 'TriggerNode') -> ExecutionResult:
        ...
        try:
            ...
            # Count lines of code
            result.lines_executed = len([line for line in code.splitlines() if line.strip()])
