...
V1_OPCODE_TO_OP: Dict[tuple, str] = {
    ...
    # NOTE: GroupBy was inserted mid-enum (pos. 4); v1 files predate it,
    # so 4..8 are select/sort/unique/split/dynamic_row_builder. 9 covers
    # files saved between the GroupBy insert and stable-op migration.
    ("preparation", 4): "preparation.select",
    ("preparation", 5): "preparation.sort",
    ("preparation", 6): "preparation.unique",
    ("preparation", 7): "preparation.split",
    ("preparation", 8): "preparation.dynamic_row_builder",
