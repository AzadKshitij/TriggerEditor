...
class ResultDock(QDockWidget):
    ...
    def initUI(self) -> None:
        ...
        self.warning_button.clicked.connect(lambda: self.filter_logs("warning"))
        ...
        self.log_table.setHorizontalHeaderLabels(["Timestamp", "Type", "Message"])
    ...
    def add_log(
        self, design_window_id: str, message: str, log_type: str = "info"
    ) -> None:
        ...
        print(
            "🐍 File: docks/result.py:71 | initUI ~ design_window_id", design_window_id
        )
    ...
    def update_log_area(self, design_window_id: str) -> None:
        ...
        for log in self.filtered_logs:
            ...
            self.log_table.setItem(row_position, 0, QTableWidgetItem(log["timestamp"]))
            self.log_table.setItem(
                row_position, 1, QTableWidgetItem(log["type"].capitalize())
            )
            self.log_table.setItem(row_position, 2, QTableWidgetItem(log["message"]))
