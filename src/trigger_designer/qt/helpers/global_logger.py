...
class GlobalLogger:
    ...
    def log(self, level: str, message: str, design_window: Optional['TriggerSubWindow'] = None) -> None:
        """
    ...
    def trace(self, message: str, design_window: Optional['TriggerSubWindow'] = None) -> None:
        """Log a TRACE message"""
        self.log("TRACE", message, design_window)
        
    def debug(self, message: str, design_window: Optional['TriggerSubWindow'] = None) -> None:
        """Log a DEBUG message"""
        self.log("DEBUG", message, design_window)
        
    def info(self, message: str, design_window: Optional['TriggerSubWindow'] = None) -> None:
        """Log an INFO message"""
        self.log("INFO", message, design_window)
        
    def warning(self, message: str, design_window: Optional['TriggerSubWindow'] = None) -> None:
        """Log a WARNING message"""
        self.log("WARNING", message, design_window)
        
    def error(self, message: str, design_window: Optional['TriggerSubWindow'] = None) -> None:
        """Log an ERROR message"""
        self.log("ERROR", message, design_window)
        
    def critical(self, message: str, design_window: Optional['TriggerSubWindow'] = None) -> None:
...
def log(level: str, message: str, design_window: Optional['TriggerSubWindow'] = None) -> None:
    """
