...
from PyQt6.QtWidgets import QApplication, QMainWindow, QVBoxLayout, QWidget, QGridLayout, QStyle, \
...
class FreeDesktopWidget(IconWidget):
    ...
    def addIcon(self, iconName, description=''):
        ...
        self._layout.addWidget(self.getLabelWithIcon(
            icon), currentRow, self.ICON_COLUMN)
